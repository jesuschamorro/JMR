 ...
 */
public class MultipleLabelDescriptor<T> extends MediaDescriptorAdapter<T> implements Serializable{
     ...
     */
    private Classifier<T, List<String>> classifier = null;
     ...
     */
    public MultipleLabelDescriptor(T media) {
     ...
     */
    public MultipleLabelDescriptor(T media, Classifier classifier) {
     ...
     */
    public MultipleLabelDescriptor(String label, String... labels) {
    ...
    public void init(T media) {
        labels = media!=null && classifier!=null ? classifier.apply(media) : null;
     ...
     */
    public void setClassifier(Classifier<T, List<String>> classifier){
        this.classifier = classifier;
    }
     ...
     */
    static class DefaultComparator implements Comparator<MultipleLabelDescriptor, Double> {
        @Override
        public Double apply(MultipleLabelDescriptor t, MultipleLabelDescriptor u) {
     ...
     */
    static public class DefaultClassifier<T> implements Classifier<T, List<String>> {
        @Override
