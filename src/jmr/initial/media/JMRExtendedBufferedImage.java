 ...
 *
 */
public class JMRExtendedBufferedImage extends BufferedImage implements JMRImage{
	...
	/**
	 * Create an ImageJMR using the {@link ImageJMR#specialType} or not.
	 *
	 *  If the {@link ImageJMR#isClassicType} it will built it like a BufferedImage otherwise
	 *  this method will create a special {@link ColorModel} and {@link SampleModel}.
	 *
	 * @param width
	 * @param height
	 * @param imageType
	...
	/**
	 * Create a {@link ImageJMR} from a file keeping in memory the path of its
	 * source filename.
	 *
	 * @param 	file
	 * @see #getSrcfile()
	...
	/**
	 * Convert an {@link ImageJMR} with <code>N</code> components in
	 * <code>N</code> {@link BufferedImage#TYPE_BYTE_GRAY} images.
	 *
	 * <p>The values of {@link ImageJMR} are scaled using {@link ColorSpaceJMR#getMaxValue(int)} and
	...
	/**
	 * Convert an {@link ImageJMR} in a {@link BufferedImage} with values scaled between
	 ...
	 *
	 * <p>
	 * This method call its super method if {@link ImageJMR#isClassicType}
	 * but use a {@link #specialType} otherwise.
	 * </p>
	 */
	public int getType() {
		if(super.getType() != 0)
	...
	/**
	 * Return a String with the most important values of {@link ImageJMR}
	 *
	 * <p><i>This function is mainly used for debugging and printing</i></p>
	 */
	...
	/**
	 * Return a String with all the important values of {@link ImageJMR}
	 *
	 * <p><i>This function is mainly used for debugging and printing</i></p>
	 */
	public String toString(boolean full) {
        ...
        /* Methods inherit from JMRImage interface */
