...
public class MPEG7HomogeneousTexture extends MPEG7TextureDescriptor {
   ...
   * <li>{@link #nofScale} = {@link #DEFAULT_NUM_SCALES}</li>
   * <li>{@link #nofOrient}= {@link #DEFAULT_NUM_ORIENTATIONS}</li>
   * <li>{@link #toNormalize}=true</li>
   * </ul></p>
   * @see #MPEG7HomogeneousTexture(int, int, boolean) 	Meaning of each parameters.
   */
  ...
  public MPEG7HomogeneousTexture(int nofScale, int nofOrient, boolean toNormalize) {
    super(MediaDescriptor.TYPE_MPEG7_HTD_DESCRIPTOR, true);
